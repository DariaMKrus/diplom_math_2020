...
функции, которые со своими обобщающими частными производными до порядка $m$ включительно принадлежат пространству $L_p(\Omega)$.
...
\begin{enumerate}
    \item что функция $v(t)$ имеет суммирующую производную $v^\prime(t);$
...
\begin{enumerate}
    \item Р. Темам. Уравнения Навье"=Стокса. Теория и численный анализ. --- Москва, 1987. --- 409 с.
    \item Аппроксимационной"=топологический переход к исследованию задач гидродинамики.
    Система Навье"=Стокса. / В.Г. Звягин, В.Т. Дмитриенко --- Москва: Едиториал УРСС, 2004. --- 112 с.
    \item О.А. Ладожская. Математические вопросы --- Москва: Наука, 1970. --- 288 с.
    \item Ж.Л. Лионс. Некоторые методы решения нелинейных краевых задач --- Москва: Мир, 1972 г., --— 587 с.
    \item Leray J. Essai sur le mouvement d'un fluide visqueux emplissant l'space --- Aeta Math, 1934, 193-248 p.
\end{enumerate}
