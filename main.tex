...
$L_p(\Omega)$ --- где $1\leqslant p<\infty$, множество измеримых функций, суммируемых с $p$-ой степенью,
...
\end{lemma}
------------------------------------------------------------------------------------------------------------------
\begin{proof} ~\\ (ТУТ НАЧИНАЕТСЯ ДИЧЬ! СМОТРИ ВО ВСЕ 4 ГЛАЗА)
        ...
        $\| \Delta v \|_{V^\ast} = \| v(t) \|_V$ для почти всех $t \in [0, T]$.\linebreak Так как $\| v(t) \|_V \in L_2(0, T)$,
        ...
        (\sum_{i,j=1}^{n}\int\limits_{\Omega}\bigg|v_i v_j\bigg|^2 dx)^{1/2}(\sum_{i,j=1}^{n}\int\limits_{\Omega}\bigg|\frac{\partial \varphi_j}{\partial x_i}\bigg|^2 dx)^{1/2}\le$$
